    ...
    <header class="header-style-3">
                ...
                <div class="container">
                  <div class="row">
                    <div class="menu-info d-flex justify-content-between align-items-center">
                      ...
                      <a href="#" class="logo"> <img src="http://localhost:5173/src/assets/images/logo/logo.png" alt="" /> </a>
              ...
              <div class="mobile-menu__sidebar-menu">
                ...
                <div class="search-box-holder">
                  <form action="#0">
                    <div class="form-group search-box menu">
                      <input type="text" class="form-control" placeholder="Search for products" /> <span class="search-icon"> <i class="flaticon-magnifying-glass"></i> </span>
                    </div>
                  </form>
                </div>
                <ul class="page-dropdown-menu">
                  <li class="dropdown-list">
                    ...
                    <router-link to="/items"><span>Ürünler </span></router-link>
                  </li>
          ...
          <div class="d-lg-block d-none">
            <div class="row g-0 position-relative">
              <div class="col-lg-3 d-flex align-items-center justify-content-center border-rit">
                <div class="logo">
                  <a href="#"> <img src="http://localhost:5173/src/assets/images/logo/logo.png" alt="" /> </a>
                </div>
              </div>
                  ...
                  <div class="col-12">
                    <div class="some-info">
                      <p class="d-flex align-items-center">
                        <span class="icon"> <i class="flaticon-power"></i> </span> ConstTier E-Ticaret Platformuna Hoşgeldiniz
                      </p>
                      ...
                      <div class="d-flex align-items-center justify-content-between">
                        <nav>
                          <ul class="page-dropdown-menu d-flex align-items-center justify-content-center">
                            <li class="dropdown-list">
                              <router-link to="/"><span>Ansayfa</span></router-link>
                            </li>
                            <li class="dropdown-list">
                              <router-link to="/items"><span>Ürünler</span></router-link>
                            </li>
                        ...
                        <div class="right d-flex align-items-center justify-content-end">
                          <ul class="main-menu__widge-box d-flex align-items-center">
                            ...
                            <li class="d-lg-block d-none">
                              <a href="wishlist.html" class="number"><i class="flaticon-heart"></i> <span class="count">(2)</span> </a>
                            </li>
                            <li class="cartm">
                              <router-link to="/cart">
                                <a class="number cart-icon"> <i class="flaticon-shopping-cart"></i><span class="count">(5)</span> </a>
                              </router-link>
                            </li>
                          </ul>
                        </div>
      ...
      <div class="sticy-header">
        ...
        <div class="container position-relative d-lg-block d-none">
          <div class="d-flex align-items-center justify-content-between">
            <a href="#" class="logo me-2"> <img src="http://localhost:5173/src/assets/images/logo/logo.png" alt="" /> </a>
            <div class="mega-menu-default mega-menu d-lg-block d-none">
              <div class="container">
                <div class="row">
                  <nav>
                    <ul class="page-dropdown-menu d-flex align-items-center justify-content-center">
                      <li class="dropdown-list">
                        <router-link to="/"><span>Anasayfa</span> <span class="menuarrow"> </span></router-link>
                      </li>
                      <li class="dropdown-list">
                        <router-link to="/items"><span>Ürünler</span> <span class="menuarrow"> </span></router-link>
                      </li>
                    </ul>
                  </nav>
                </div>
      ...
      <div class="sidebar-content">
        <div class="sidebar-widget-container">
          <div class="widget-heading d-flex justify-content-end align-content-center"><span class="close-side-widget">X</span></div>
          <div class="sidebar-textwidget">
            <div class="sidebar-info-contents">
              <div class="content-inner">
                <div class="logo">
                  <a href="#"><img src="http://localhost:5173/src/assets/images/logo/logo-2.png" alt="" /></a>
                </div>
                ...
                <div class="sidebar-contact-info">
                  ...
                  <ul>
                    ...
                    <li><span class="flaticon-telephone"></span> <a href="tel:+44203700001">+44 123 456 789</a></li>
        ...
        <div class="container">
          <div class="footer_bottom_content">
            <div class="copyright wow fadeInUp animated">
              <p>© 2022 <a href="#">ConstTier.</a> Bütün haklar saklıdır.</p>
            </div>
